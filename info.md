...
- **Stay on [`ifMike/homeyHASS-legacy`](https://github.com/ifMike/homeyHASS-legacy)** in HACS until you are ready to migrate manually. That repository only publishes **1.2.x** updates (no 2.x notifications).
